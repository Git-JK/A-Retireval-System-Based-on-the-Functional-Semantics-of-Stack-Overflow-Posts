...
from baseline.question_retrieval.get_dq import calc_similarity
from baseline.utils.data_util import load_idf_vocab, load_w2v_model

def MMR_Analysis(query, top_ss, topnum):
    ss_top_ss = [x[0] for x in top_ss]
    sim_matrix = build_sim_matrix(query, ss_top_ss)
