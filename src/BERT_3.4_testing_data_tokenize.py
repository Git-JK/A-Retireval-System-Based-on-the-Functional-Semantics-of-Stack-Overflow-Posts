...
from utils.config import BERT_Q_A_TEST_TOKEN_STORE_PATH, BERT_Q_QD_TEST_TOKEN_STORE_PATH, BERT_Q_A_TEST_DATA_STORE_PATH, BERT_Q_QD_TEST_DATA_STORE_PATH
...
def testing_data_tokenize(bert_model_type, data_dir_path, token_store_path):
...
if __name__ == "__main__":
    ...
    testing_data_tokenize(bert_model_type, BERT_Q_QD_TEST_DATA_STORE_PATH, BERT_Q_QD_TEST_TOKEN_STORE_PATH)
    testing_data_tokenize(bert_model_type, BERT_Q_A_TEST_DATA_STORE_PATH, BERT_Q_A_TEST_TOKEN_STORE_PATH)
